...
- [docs/hard-guardrails.md](/Users/xmly/Projects/MyCodex/Health/docs/hard-guardrails.md)
...
一期公网方案采用 `Cloudflare Tunnel + 主备切换`：

- 主站：公司局域网服务器
- 备站：本地开发机
- 正式入口：`app.wellai.online`
- 备站入口：`backup.wellai.online`

具体操作见：

- [deploy/PUBLIC_ACCESS.md](/Users/xmly/Projects/MyCodex/Health/deploy/PUBLIC_ACCESS.md)
...
- 发布硬规范见：`docs/hard-guardrails.md`（包含“防串用户 / 主备一致 / 测试账号不可见”的上线门禁）。
