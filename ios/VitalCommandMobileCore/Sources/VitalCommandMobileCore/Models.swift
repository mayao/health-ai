...
public struct UserCapabilities: Codable, Sendable {
    public let canSwitchAccounts: Bool
    public let canCreateTestUsers: Bool
    public let canSeeAdvancedSettings: Bool
    public let canUseDirectDeviceEntry: Bool

    public init(
        canSwitchAccounts: Bool = false,
        canCreateTestUsers: Bool = false,
        canSeeAdvancedSettings: Bool = true,
        canUseDirectDeviceEntry: Bool = true
    ) {
        self.canSwitchAccounts = canSwitchAccounts
        self.canCreateTestUsers = canCreateTestUsers
        self.canSeeAdvancedSettings = canSeeAdvancedSettings
        self.canUseDirectDeviceEntry = canUseDirectDeviceEntry
    }
}
...
public struct UserInfo: Codable, Sendable {
    ...
    public let phoneNumber: String?
    public let email: String?
    public let capabilities: UserCapabilities
    ...
    public init(
        ...
        email: String? = nil,
        capabilities: UserCapabilities = UserCapabilities(),
    ...
    public init(from decoder: Decoder) throws {
        ...
        capabilities = try container.decodeIfPresent(UserCapabilities.self, forKey: .capabilities) ?? UserCapabilities()
