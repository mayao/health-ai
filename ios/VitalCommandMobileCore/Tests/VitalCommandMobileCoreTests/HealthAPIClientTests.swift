...
struct HealthAPIClientTests {
    ...
    func signsInWithAppleAndDecodesProviderMetadata() async throws {
            ...
            body: """
            {
              ...
              "user": {
                ...
                "capabilities": {
                  ...
                  "canCreateTestUsers": false,
                  "canSeeAdvancedSettings": true,
                  "canUseDirectDeviceEntry": true
                },
                "authProviders": [
        ...
        #expect(response.user.capabilities.canSeeAdvancedSettings)
        #expect(response.user.capabilities.canUseDirectDeviceEntry)
